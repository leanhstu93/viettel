...
<div class="page-content w100">
    ...
    <p class="post-meta">
        <span class="post-meta-author">
            ...
            <a href="https://3gviettel.vn/author/3gviettel" title="">3gviettel </a>
        </span>
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="share-products">
                                        ...
                                        <ul class="sociallinks-style-two fix">
                                            <li><a href="#"><i class="fab fa-facebook-square fb" aria-hidden="true"></i></a>
                                            </li>
                                            <li><a href="#"><i class="fab fa-twitter-square tw" aria-hidden="true"></i></a>
                                            </li>
                                            <li><a href="#"><i class="fab fa-google-plus-square pin"
                                                               aria-hidden="true"></i></a></li>
                                            <li><a href="#"><i class="fab fa-linkedin lin" aria-hidden="true"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab active-tab" id="review">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="single-review-box">
                                                        ...
                                                        <div class="text-holder">
                                                            <div class="top">
                                                                <div class="name">
                                                                    <h3>Steven Rich <span>– September 17, 2019:</span>
                                                                    </h3>
                                                                </div>
                                                                <div class="review-box">
                                                                    <ul>
                                                            ...
                                                            <div class="text">
                                                                <p>Value for money , I use it from long time and it is
                                                                    very useful and good product.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="single-review-box">
                                                        ...
                                                        <div class="text-holder">
                                                            <div class="top">
                                                                <div class="name">
                                                                    <h3>William Cobus <span>– September 17, 2019:</span>
                                                                    </h3>
                                                                </div>
                                                                <div class="review-box">
                                                                    <ul>
                                                            ...
                                                            <div class="text">
                                                                <p>We denounce with righteous indignation and dislike
                                                                    men who are so beguiled & demoralized.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="review-form">
                                            ...
                                            <form id="review-form" action="#">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <button class="theme-btn btn-style-one" type="submit">Submit Now<span
                                                                    class="icon-thin-right-arrow"></span></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
